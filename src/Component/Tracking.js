...
const TrackOrder = () => {
  ...
  const handleTrackOrder = (trackingNumber) => {
    // Check if the tracking number is exactly 9 numeric digits
    const isValidTrackingNumber = /^\d{9}$/.test(trackingNumber);
      ...
      {isExpanded && (
        <table className="extra-details">
          <tbody>
            ...
            <tr>
              <td className="detail-label">Scan Remark</td>
              <td>{trackingDetails.scan_remark}</td>
            </tr>
            <tr>
            ...
            <tr>
              <td className="detail-label">No.of Boxes</td>
