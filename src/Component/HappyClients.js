        ...
        <div className="row mt-5 mt-md-4 row-cols-1 row-cols-sm-1 row-cols-md-3 justify-content-center">
          <div className="col">
            <div className="service-card">
              ...
              <h3>Happy clients</h3>
              <p>
              More than 30,000 satisfied clients have availed of our services and solutions
              </p>
            </div>
          </div>
          <div className="col">
            <div className="service-card">
              ...
              <p>
              We have delivered 100,000+ shipments to various destinations
              </p>
            </div>
          </div>
          <div className="col">
            <div className="service-card">
              ...
              <p>
              Our services cover more than 22,000 pincodes across the country
              </p>
            </div>
          </div>
          <div className="col">
