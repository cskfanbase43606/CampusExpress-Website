...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    if (email) {
      setEmail(email);
      setMessage("I am writing to propose a partnership with Campus Express. We believe that our collaboration could bring mutual benefits and enhance the logistics for us.");
    }
  }, []);
